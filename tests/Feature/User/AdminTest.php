...
class AdminTest extends TestCase
{
    ...
    public function test_admin_can_view_user_index_page_after_login()
    {
        $this->signInAdmin();
        $response = $this->get(route('dashboard.users.index'));
        $response->assertSessionHasNoErrors();
    ...
    public function test_admin_can_view_user_create_page_after_login()
    {
        $this->signInAdmin();
    ...
    public function test_admin_can_view_user_page_after_login()
    {
        $this->signInAdmin();
        // create a user
    ...
    public function test_admin_can_edit_user_page_after_login()
    {
        $this->signInAdmin();
        // create a user
        $user = User::factory()->create();
