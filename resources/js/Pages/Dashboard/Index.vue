    ...
    <div class="content m-1">
      ...
      <div class="grid grid-cols-2 gap-2 md:grid-cols-3 md:gap-4 lg:gap-8 mt-4">
        <div v-for="school in schools"
             :key="school.id" class="relative cursor-pointer transition transform ease-in-out hover:scale-105 hover:shadow-lg">
          <Card class="bg-blue-200 h-32 lg:h-40 flex justify-center items-center"
                @click="visit(school)">
            <p class="text-gray-700 absolute top-1 left-1">
              <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                ...
                <path d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222" stroke-linecap="round" stroke-linejoin="round"
                      stroke-width="2"/>
              </svg>
            </p>
...
export default {
  ...
  methods: {
    visit(school) {
      this.$inertia.visit(route('dashboard.reports.index', school.id))
    },
